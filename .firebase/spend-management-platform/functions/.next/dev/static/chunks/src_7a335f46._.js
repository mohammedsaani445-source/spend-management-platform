    ...
    const handleAction = async (id, action)=>{
        ...
        try {
            ...
            if (action === 'APPROVED' && user?.uid) {
                ...
                if (req) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$purchaseOrders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPOFromRequisition"])(req, user.uid);
...
//# sourceMappingURL=src_7a335f46._.js.map