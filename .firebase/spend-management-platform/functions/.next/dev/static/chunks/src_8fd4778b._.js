...
"[project]/src/components/approvals/ApprovalFocusModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$requisitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/requisitions.ts [app-client] (ecmascript)"); // For price check
;
...
function ApprovalFocusModal({ requisition, budget, deptSpend, onClose, onApprove, onReject }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ApprovalFocusModal.useEffect": ()=>{
            const fetchHistory = {
                "ApprovalFocusModal.useEffect.fetchHistory": async ()=>{
                    try {
                        ...
                        requisition.items.forEach({
                            "ApprovalFocusModal.useEffect.fetchHistory": (currentItem)=>{
                                // Find previous approved requests containing this item
                                const match = allReqs.filter({
                                    "ApprovalFocusModal.useEffect.fetchHistory": (r)=>r.status === 'APPROVED' || r.status === 'ORDERED'
                                }["ApprovalFocusModal.useEffect.fetchHistory"]).flatMap({
                                    "ApprovalFocusModal.useEffect.fetchHistory": (r)=>r.items.map({
                                            "ApprovalFocusModal.useEffect.fetchHistory": (i)=>({
                                                    ...i,
                                                    date: r.createdAt
                                                })
                                        }["ApprovalFocusModal.useEffect.fetchHistory"])
                                }["ApprovalFocusModal.useEffect.fetchHistory"]).filter({
                                    "ApprovalFocusModal.useEffect.fetchHistory": (prevItem)=>prevItem.description.toLowerCase() === currentItem.description.toLowerCase()
                                }["ApprovalFocusModal.useEffect.fetchHistory"]).sort({
                                    "ApprovalFocusModal.useEffect.fetchHistory": (a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()
                                }["ApprovalFocusModal.useEffect.fetchHistory"])[0]; // Get latest
                                if (match) {
                                    history.push({
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        className: "jsx-f8b0b170309b69fa",
                                        children: requisition.items.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                style: {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                remainingAfter < 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    style: {
                                                        color: '#ef4444',
                                                        fontWeight: 700
                                                    },
                                                    ...
                                                    children: [
                                                        "⚠️ Over Budget by ",
                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currencies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(Math.abs(remainingAfter), 'USD')
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/src/components/approvals/ApprovalFocusModal.tsx",
                                                    lineNumber: 187,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        loadingHistory ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            lineNumber: 217,
                                            columnNumber: 33
                                        }, this) : priceHistory.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            style: {
                                                display: 'flex',
                                                flexDirection: 'column',
                                                gap: '0.75rem'
                                            ...
                                            className: "jsx-f8b0b170309b69fa",
                                            children: priceHistory.map((h, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    style: {
                                                        fontSize: '0.875rem'
                                                    },
                                                    className: "jsx-f8b0b170309b69fa",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    className: "jsx-f8b0b170309b69fa",
                                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currencies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(h.lastPrice, requisition.currency)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/approvals/ApprovalFocusModal.tsx",
                                                                    lineNumber: 225,
                                                                    columnNumber: 49
...
_s(ApprovalFocusModal, "zTvzAsapy0j2oieddGBX30zE904=");
_c = ApprovalFocusModal;
var _c;
__turbopack_context__.k.register(_c, "ApprovalFocusModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$purchaseOrders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/purchaseOrders.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$approvals$2f$ApprovalFocusModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/approvals/ApprovalFocusModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ApprovalsPage() {
    ...
    const [deptBudget, setDeptBudget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [deptSpend, setDeptSpend] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const handleOpenRequest = async (req)=>{
        try {
            const [budgets, analytics] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$budgets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBudgets"])(),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpendAnalytics"])() // This would ideally filter by dept in a real backend API
            ]);
    ...
    const handleAction = async (id, action)=>{
        ...
        try {
            if (action === 'APPROVED' && selectedReq) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$purchaseOrders$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPOFromRequisition"])(selectedReq, user?.uid || 'system');
            } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            selectedReq && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$approvals$2f$ApprovalFocusModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ApprovalsPage, "cqoatKONFDS9rBXs8rXkqmVpbwU=", false, function() {
    return [
...
//# sourceMappingURL=src_8fd4778b._.js.map